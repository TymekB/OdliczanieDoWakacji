let app = new Vue({
	el: "#countdown",
	data: {
		startDate: new Date(new Date().getFullYear(), 8, 2),
		endDate: new Date(new Date().getFullYear()+1, 5, 27),
		dateDifference: null,
		progress: null
	},
	methods: {
		countDateDifference(start, end) {
	...
	created() {
		...
		this.dateDifference = this.countDateDifference(this.startDate, this.endDate);
